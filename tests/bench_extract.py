...
Example output:
    === graphify-b AST Extraction Benchmark ===
    Files:        1,247
...
from graphify_m.extract import extract, collect_files
from graphify_m.cache import clear_cache
...
def main() -> None:
    ...
    print("=== graphify-b AST Extraction Benchmark ===\n")
