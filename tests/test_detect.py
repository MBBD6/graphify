...
from graphify_m.detect import classify_file, count_words, detect, FileType, _looks_like_paper, _is_ignored, _load_graphifyignore
...
def test_classify_video_extensions():
    ...
    from graphify_m.detect import FileType
