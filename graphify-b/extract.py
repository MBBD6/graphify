...
def _check_tree_sitter_version() -> None:
    ...
    if LANGUAGE_VERSION < 14:
        ...
        raise RuntimeError(
            ...
            f"graphify-b requires tree-sitter >= 0.23.0 (Language API v2). "
...
def extract(
    ...
    *,
    ...
    Args:
        ...
        cache_root: explicit root for graphify-b-out/cache/ (overrides the
            inferred common path prefix). Pass Path('.') when running on a
            subdirectory so the cache stays at ./graphify-b-out/cache/.
