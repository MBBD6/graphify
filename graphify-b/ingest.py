...
def save_query_result(
    ...
    Files are stored in memory_dir (typically graphify-b-out/memory/) with YAML frontmatter
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Fetch a URL into a graphify-b /raw folder")
