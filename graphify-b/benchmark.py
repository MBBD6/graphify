"""Token-reduction benchmark - measures how much context graphify-b saves vs naive full-corpus approach."""
...
def run_benchmark(
    graph_path: str = "graphify-b-out/graph.json",
    corpus_words: int | None = None,
    questions: list[str] | None = None,
) -> dict:
    """Measure token reduction: corpus tokens vs graphify-b query tokens.
