...
# Used by `graphify_b . --backend kimi` and the benchmark scripts.
# The default graphify_b pipeline uses Claude Code subagents via skill.md;
...
_EXTRACTION_SYSTEM = """\
You are a graphify_b semantic extraction agent. Extract a knowledge graph fragment from the files provided.
