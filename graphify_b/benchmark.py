"""Token-reduction benchmark - measures how much context graphify_b saves vs naive full-corpus approach."""
...
def run_benchmark(
    graph_path: str = "graphify_b-out/graph.json",
    corpus_words: int | None = None,
    questions: list[str] | None = None,
) -> dict:
    """Measure token reduction: corpus tokens vs graphify_b query tokens.
