...
Usage examples:
  ...
  python scripts/visuals/viz_focus.py --communities 1,2,5 --out graphify-out/graph_comm_1_2_5.html
"""
...
def parse_args():
    ...
    p.add_argument("--out", type=str, help="Output HTML path", default="graphify-out/graph_top.html")
    return p.parse_args()
