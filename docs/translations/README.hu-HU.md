...
> **Hivatalos csomag:** A PyPI-csomag neve `graphifyy-m`. Az egyetlen hivatalos tároló a [safishamsi/graphify](https://github.com/safishamsi/graphify).
...
/graphify-b query "mi köti össze az Attentiont az optimalizálóval?"
...
A [**Penpax**](https://safishamsi.github.io/penpax.ai) a graphify-b feletti vállalati réteg. **Ingyenes próbaverzió hamarosan.** [Csatlakozzon a várólistához →](https://safishamsi.github.io/penpax.ai)
