...
Completamente multimodale. Aggiungi codice, PDF, markdown, screenshot, diagrammi, foto di lavagne, immagini in altre lingue, o file video e audio — graphify-b estrae concetti e relazioni da tutto e li connette in un unico grafo. I video vengono trascritti localmente con Whisper. Supporta 25 linguaggi di programmazione via tree-sitter AST.

> Andrej Karpathy mantiene una cartella `/raw` dove deposita paper, tweet, screenshot e note. graphify-b è la risposta a quel problema — **71,5x** meno token per query rispetto alla lettura dei file grezzi, persistente tra le sessioni.

```
/graphify-b .                        # funziona con qualsiasi cartella
```
...
```
/graphify-b .
/graphify-b ./raw --update           # solo file modificati
/graphify-b ./raw --mode deep
/graphify-b query "cosa connette Attention all'ottimizzatore?"
...
## Costruito su graphify-b — Penpax
