# graphify-b Evaluation - Mixed Corpus (2026-04-04)
...
**Finding:** Communities are semantically correct - the three graphify-b modules map cleanly
...
saved to `graphify-b-out/memory/`.
...
detect() on eval root with graphify-b-out/memory/ present:
...
**What graphify-b extracts (Claude vision reads directly, no reshaper/bidi needed):**
...
**Nodes graphify-b would extract:**
...
identically to English. The image node in graphify-b is just a path - the vision subagent does
the rest.
