# graphify_b Evaluation - Mixed Corpus (2026-04-04)
...
**Finding:** Communities are semantically correct - the three graphify_b modules map cleanly
...
saved to `graphify_b-out/memory/`.
...
detect() on eval root with graphify_b-out/memory/ present:
...
**What graphify_b extracts (Claude vision reads directly, no reshaper/bidi needed):**
...
**Nodes graphify_b would extract:**
...
identically to English. The image node in graphify_b is just a path - the vision subagent does
the rest.
